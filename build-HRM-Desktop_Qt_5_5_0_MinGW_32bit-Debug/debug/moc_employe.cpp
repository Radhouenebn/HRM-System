...
QT_MOC_LITERAL(1, 8, 15), // "ajouter_employe"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 16) // "modifier_employe"

    },
    "employe\0ajouter_employe\0\0modifier_employe"
};
...
void employe::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ajouter_employe(); break;
        case 1: _t->modifier_employe(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject employe::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_employe.data,
      qt_meta_data_employe,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *employe::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_employe.stringdata0))
        return static_cast<void*>(const_cast< employe*>(this));
